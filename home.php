    ...
    <div class="navbar navbar-dark bg-dark shadow-sm">
      <div class="container">
        ...
        <ul class="nav justify-content-end">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="profile.php?username=<?echo $_COOKIE['username']?>">Welcome, <?=get_fullname()?></a>
          </li>
          <li class="nav-item">
              ...
              <div class="card shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-secondary" onclick = "location.href='profile.php?username=<?echo $post['username']?>'"><?=$post['username']?></button>
                    </div>
